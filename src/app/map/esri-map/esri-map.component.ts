...
export class EsriMapComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    loadModules([
      ...
      setTimeout(() => {
        this.rotateSVG(this._rotateDegree);    
        this._rotateDegree += 90;
      }, 3000);
  ...
  checkSVG() {
    this.mapView.watch('zoom', (e) => {
      ...
      transMatrix[4] -= (1 / scale - 1) * (x + 40); // 40 is half of element width
